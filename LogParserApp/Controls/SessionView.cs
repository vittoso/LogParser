...
namespace LogParserApp.Controls
{
    public partial class SessionView : UserControl
    {
        ...
        public void Init(LogParserSession currentSession)
        {
            ...
            var dateTimeRange = currentSession.GetTotalDateTimeRange();
        ...
        private void SetInitialDateRange((DateTime start, DateTime end) dateTimeRange)
        {
            dtpStart.ValueChanged -= DtpStart_ValueChanged;
            dtpEnd.ValueChanged -= DtpEnd_ValueChanged;
            dtpEnd.Value = dateTimeRange.end.AddDays(1).Date;
